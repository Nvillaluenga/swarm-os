...
export default function Header() {
  return (
    <header className="fixed top-0 left-0 w-full z-[100] flex justify-between items-center px-6 h-20 bg-white/60 dark:bg-black/60 backdrop-blur-[20px] docked full-width border-b-4 border-black dark:border-white shadow-[0px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[0px_4px_0px_0px_rgba(163,230,53,1)]">
      <div className="flex items-center gap-4 border-r-4 border-black dark:border-lime-400 pr-6 h-full">
        <span className="text-2xl font-black italic tracking-widest text-black dark:text-lime-400 font-h1 uppercase">SWARM_OS</span>
      </div>
      ...
      <div className="flex items-center gap-4 h-full pl-6 border-l-4 border-black dark:border-lime-400">
