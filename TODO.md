...
- [ ] **Phase 4: Verification**
    - [ ] Create a complex test goal to verify the multi-agent interaction.
    - [ ] Verify the context check and critique loop manually.
...
- [/] **Phase 12: UI Improvements (Sorting & Titles)**
...
- [ ] **Phase 16: Remove Default Card Hue**
    - [ ] Update `Card.tsx` to make `bgHue` optional.
    - [ ] Update `ExecutionOverview.tsx` to use `neon` hue.
    - [ ] Verify build and visual effect.
